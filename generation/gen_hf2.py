...
class ScriptArguments:
    ...
    model_name_or_path: Optional[str] = field(
        default="pwork7/gemma7b_meta_math_3epoch_with_kn",
...
for i, output in enumerate(outputs):
    tmp_data = {"idx": ds[i]['idx'], 'solution': ds[i]['solution'], 'type': ds[i]['type'], 'my_solu': ds[i]['my_solu'], 'prompt': ds[i]['prompt'], "new_prompt": ds[i]["new_prompt"], "responses": [out.text for out in output.outputs]}
